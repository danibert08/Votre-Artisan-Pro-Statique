...
<body class="purple">  
    <main class="mentions">
        ...
        <div>
            ...
            <p>Nom / Raison sociale : La Belle Peinture<p>
            <p>Forme juridique : Sarlu</p>
            <p>SIRET : 820 407 039 00016</p>
            <p>Numéro TVA intracommunautaire : FR68820407039</p><br>
            <p>Adresse du siège social : </p><br>
            <address>
                3 Rue des Goélands <br>
                85560 LE BERNARD <br>
                Téléphone : 06.01.75.38.24  <br><br>
                Email :  contact@labellepeinture-vendee.fr
            </address><br>
            <p>Le directeur de la publication est : Laurent BAKIR</p><br>
        </div>
        <div>
            ...
            <h2>Activité :</h2><br>
            <p>Le présent site a pour objet de présenter les services de : La Belle Peinture</p>
            <p>Description de l’activité : travaux de peinture et de vitrerie</p><br>
            ...
            <p>Les informations collectées via les formulaires sont destinées uniquement à La Belle Peinture afin de répondre aux demandes des utilisateurs. <br>
            ...
            Email : contact@labellepeinture-vendee.fr</p><br>
