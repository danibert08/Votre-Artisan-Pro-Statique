...
<head>
    ...
    <meta name="description" content="Ypria vous présente son activité de prothésiste ongulaire et de maquilleuse aux Sables d'Olonne" />
    <?php 
        ...
        <header>
            ...
            <div id="accueil" class="en-tete">
                ...
                <div class="en-tete__logo">
                    <img class="en-tete__logo_logo-img" src="/pages_artisans/<?= $data['nom'] ?>/images/logo/logo.jpeg"  alt="">
                </div>
            </div>
